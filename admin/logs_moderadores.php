...
// Buscar logs dos moderadores
$logs = $pdo->query("
    SELECT lm.*, 
           um.nome as moderador_nome,
           ua.nome as usuario_afetado_nome
    FROM logs_moderadores lm
    LEFT JOIN usuarios um ON lm.moderador_id = um.id
    LEFT JOIN usuarios ua ON lm.usuario_afetado_id = ua.id
...
<head>
    ...
    <title>Dashboard - Logs de Moderadores</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <div class="nav-section">
                ...
                <a href="logs_moderadores.php" class="nav-item active">
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="page-content">
            <section class="welcome-section">
                <h2 class="welcome-title">Logs de Moderadores</h2>
                <p class="welcome-subtitle">Monitore todas as ações realizadas pelos moderadores</p>
            </section>
            ...
            <div class="content-container">
                ...
                <?php if (empty($logs)): ?>
                    <div class="empty-state">
                        ...
                        <div class="empty-subtitle">As ações dos moderadores aparecerão aqui</div>
                    </div>
                <?php else: ?>
                    <div class="logs-grid">
                        <?php foreach ($logs as $log): ?>
                            <div class="log-item">
                                <div class="log-header">
                                    <div class="log-info">
                                        <div class="log-action"><?= htmlspecialchars($log['acao']) ?></div>
                                        <div class="log-moderator">
                                            <i class="fas fa-user-shield"></i>
                                            Moderador: <?= htmlspecialchars($log['moderador_nome']) ?>
                                        </div>
                                        <?php if (!empty($log['detalhes'])): ?>
                                            <div class="log-details"><?= htmlspecialchars($log['detalhes']) ?></div>
                                        <?php endif; ?>
                                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('%c📋 Logs de Moderadores carregados!', 'color: #22c55e; font-size: 16px; font-weight: bold;');
